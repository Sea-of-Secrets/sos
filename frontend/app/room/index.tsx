...
export default function Room() {
  ...
  //   }
  // };
  const handleConfirm = () => router.push("/room/roomcode123456");
                  ...
                  <div>
                    <div className="mt-3 text-center sm:mt-5">
                      ...
                      <fieldset className="mt-3">
                        <div className="space-y-4 m-5 sm:flex sm:justify-center sm:space-x-10 sm:space-y-0">
